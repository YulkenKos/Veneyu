loadstring([==[
-- Delta Game Pass Menu
local Players = game:GetService("Players")
local player = Players.LocalPlayer

-- CONFIG: IDs de los Game Pass que quieras “activar”
local GAMEPASS_IDS = {12345678, 87654321} -- reemplaza con los IDs de tu juego
